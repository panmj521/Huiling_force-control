...
class MassageRobot:
    ...
    def init_hardwares(self,ready_pose):
        ...
        #修改，只绕Z轴旋转，类似于euler_angles = [0:0:0.3]
    ...
    def update_wrench(self):
        ...
        # print("----------------none_palyload--------")
        # print("gravity_base",gravity_base)
        # print("force_zero",force_zero)
        # print("torque_zero",torque_zero)
        # print("tool_position",tool_position)
        # print("mass_center_position",mass_center_position)
        # print("--------------end--------------------")
        ...
        if sensor_data is None:
            ...
            return
        # print("first_sense_data",sensor_data[:3])        
        # 反重力补偿
        sensor_data[:3] = sensor_data[:3] + force_zero + b_rotation_s_set0.T @ gravity_base
        # print("b_rotation_s_set0.T",b_rotation_s_set0.T)
        # print("scoend_sense_data",sensor_data[:3])        
        ...
        # print("external_wrench_tcp ",self.arm_state.external_wrench_tcp )
    ...
    def generate_max_ellipse_spiral_cloudPoint(self, ellipse_a, ellipse_b, tmp_center_point):
        ...
        spiral_r,spiral_num = 0.15*ellipse_a,20
...
if __name__ == "__main__":
    ...
    robot.switch_payload('roller_head')
